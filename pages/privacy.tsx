			...
			<PrivacyMain>
				<PrivacyPolicy>
					...
					<p>
						...
						<Anchor href="https://disstreamchat.com" newTab>
						...
						by DisStreamChat and how we use it.
					</p>
					...
					<p>
						...
						and/or collect in DisStreamChat. This policy is not applicable to any
					...
					<p>
						DisStreamChat follows a standard procedure of using log files. These files
						...
						help of the{" "}
						<Anchor newTab href="https://www.privacypolicygenerator.info">
			...
			<p>
				For more general information on cookies, please read <a href="https://www.cookieconsent.com/what-are-cookies/">"What Are Cookies"</a>.
					...
					<p>
						...
						advertising partners of DisStreamChat.
					</p>

					<p>
						Third-party ad servers or ad networks uses technologies like cookies,
						JavaScript, or Web Beacons that are used in their respective advertisements
						and links that appear on DisStreamChat, which are sent directly to users'
					...
					<p>
						Note that DisStreamChat has no access to or control over these cookies that
					...
					<p>
						DisStreamChat's Privacy Policy does not apply to other advertisers or
					...
					<p>
						DisStreamChat does not knowingly collect any Personal Identifiable
