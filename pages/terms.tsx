...
const Terms = () => {
	return (
		<>
			<Head>
				<title>DisStreamChat | Terms of Service</title>
			</Head>
			<PrivacyMain>
				<PrivacyPolicy>
					...
					<p>
						The DisStreamChat website located at https://www.disstreamchat.com is a
						copyrighted work belonging to DisStreamChat. Certain features of the Site
					...
					<p>
						...
						<Anchor newTab href="https://www.termsofusegenerator.net">
					...
					<p>
						<strong>Subject to these Terms.</strong>the Company grants you a
					...
					<p>
						...
						trade secrets, in the Site and its content are owned bythe Company orthe
						...
						rights, except for the limited access rights expressed in Section 2.1.the
					...
					<p>
						...
						third-parties.  Such Third-Party Links & Ads are not under the control ofthe
						Company, andthe Company is not responsible for any Third-Party Links &
						Ads. the Company provides access to these Third-Party Links & Ads only as a
					...
					<p>
						<strong>Other DashBoard.</strong> Each Site user is solely responsible for
					...
					<p>
						...
						DisStreamChat uses ‘cookies’. These cookies are used to store information
					...
					<p>
						The site is provided on an "as-is" and "as available" basis, andthe Company
					...
					<p>
						To the maximum extent permitted by law, in no event shallthe Company or our
						...
						site even ifthe Company has been advised of the possibility of such
					...
					<p>
						...
						Content associated with your Account from our live databases. the Company
					...
					<p>
						...
						be sent to: 839 ivy trail way. After the Notice is received, you and the
					...
					<p>
						...
						acquired fromthe Company, or any products utilizing such data, in violation
					...
					<p>
						...
						andthe Company use electronic means, whether you use the Site or send us
						emails, or whetherthe Company posts notices on the Site or communicates with
						you via email. For contractual purposes, you (a) consent to receive
						communications fromthe Company in an electronic form; and (b) agree that all
					...
					<p>
						...
						permitted by law.  Your relationship tothe Company is that of an independent
						...
						void. the Company may freely assign these Terms.  The terms and conditions
