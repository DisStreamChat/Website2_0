...
export const RankCard = (props) => {
    ...
    useEffect(() => {
        (async () => {
            ...
            const statuses = {
                ...
                offline:
                    "https://cdn.discordapp.com/emojis/702707414927015966.png?v=1",
            };
    ...
    const displayXp =
        xpProgress > 1000
            ? `${(xpProgress / 1000).toFixed(2)}k`
            : Math.floor(xpProgress);
    const displayXpToGo =
        xpLevelDif > 1000 ? `${(xpLevelDif / 1000).toFixed(2)}k` : xpLevelDif;
    ...
    return (
        ...
        >
            ...
            <rect
                ...
                style={{
                    fill: `${
                        backgroundImage ? "url(#bgImage)" : backgroundColor1
                    }`,
                }}
            ></rect>
            ...
            <rect
                ...
                style={{
                    ...
                    opacity: userData?.backgroundOpacity / 255,
                }}
            ></rect>
